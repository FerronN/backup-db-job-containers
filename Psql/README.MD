...
3. Loops through each connectable database and performs the following steps:
    - Creates a `.dump` backup filename using the database name and current timestamp.
